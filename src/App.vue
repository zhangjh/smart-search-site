      ...
      <div class="hero-content">
        <div class="logo-section">
          ...
          <div class="hero-text">
            ...
            <p class="subtitle">AI文图搜索，快速定位记忆的瞬间</p>
            <div class="feature-tags">
              <span class="tag">OpenAI 强力模型</span>
              <span class="tag">语义检索 秒出结果</span>
              <span class="tag">无需联网 本地运行</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="description-section">
      <div class="container">
        <div class="description-card">
          <h2 class="section-title">智能搜索，触手可及</h2>
          <div class="description-content">
            <p class="highlight-text">
              慧搜是一个基于OpenAI CLIP模型的智能文图搜索应用程序，完全运行在手机本地环境，不需要连接互联网。
              它可以支持使用文本关键词、照片描述甚至照片分类信息等文本来快速定位手机图片。
            </p>
            <p>
              你一定遇到过这样的时候：突然想起来曾经有一张很有趣的图，它就躺在你的手机相册里，但是奈何相册图片实在太多翻不过来。
            </p>
            <p>
              使用慧搜，你可以使用任何你能想到的关于图片的描述信息来寻找你想要的某张图片。如"红色的花"、"可爱的小朋友"、"两个人的合照"、"傍晚的夕阳"、"海边看日出"、"表情包"、"结婚啦"……
            </p>
            <p class="privacy-text">
              而这一切，都仅仅发生在你的设备本地，它不需要联网，你也不用担心隐私泄露，你的相册、你的搜索，只有你知道。
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="footer-content">
          <div class="footer-links">
            <a class="footer-link" href="/index_en.html">SmartSearch</a>
            <a class="footer-link" href="/privacy.html">隐私声明</a>
            <a class="footer-link" href="/guide.html">使用说明</a>
          </div>
        </div>
      </div>
    </footer>
